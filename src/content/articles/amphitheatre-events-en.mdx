...
The **Žnjan open-air amphitheatre** was built as part of the €45.5M beach renovation and has quickly become one of Split's most distinctive event venues. Located at the western end of the Žnjan promenade, it combines a seaside setting with purpose-built performance infrastructure.
...
1. **Visit Split** (visitsplit.com) — The city tourism board lists major events
2. **Žnjan venue social media** — Follow the beach clubs and the Žnjan promenade accounts on Instagram
3. **Local event sites** — splitski.portal.hr, slobodnadalmacija.hr (events section)
4. **Hotel concierge** — If staying at a Žnjan hotel, the front desk usually knows what's on
5. **Posters on the promenade** — Events are often advertised on-site
